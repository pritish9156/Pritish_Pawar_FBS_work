...
CREATE TABLE `procedure_report` (
  `procedure_report_id` int NOT NULL AUTO_INCREMENT,
  `encounter_id` int NOT NULL,
  `procedure_id` int NOT NULL,
  `procedure_outcome` varchar(100) DEFAULT NULL,
  ...
  CONSTRAINT `procedure_report_ibfk_1` FOREIGN KEY (`encounter_id`) REFERENCES `encounter` (`encounter_id`),
  CONSTRAINT `procedure_report_ibfk_2` FOREIGN KEY (`procedure_id`) REFERENCES `medical_procedure` (`procedure_id`)
...
INSERT INTO `procedure_report` VALUES (1,1,1,'normal','2024-01-10','2026-02-11 18:40:06','2026-02-11 18:40:06','completed'),(2,2,5,'successful','2024-01-11','2026-02-11 18:40:06','2026-02-11 18:40:06','no complications'),(3,3,4,'improved mobility','2024-01-12','2026-02-11 18:40:06','2026-02-11 18:40:06','therapy started'),(4,4,1,'normal','2024-01-13','2026-02-11 18:40:06','2026-02-11 18:40:06','stable'),(5,5,2,'successful','2024-01-14','2026-02-11 18:40:06','2026-02-11 18:40:06','no issues');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `procedure_invoice_item` AFTER INSERT ON `procedure_report` FOR EACH ROW begin
