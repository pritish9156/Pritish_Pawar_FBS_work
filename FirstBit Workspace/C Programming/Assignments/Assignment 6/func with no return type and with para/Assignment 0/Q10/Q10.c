...
void findTotalPercentage(int,int,int,int,int);
void main(){
	
	//initialization
	int sub1 = 40, sub2 = 65, sub3 = 70, sub4 = 80, sub5 = 50;
	
	findTotalPercentage(sub1,sub2,sub3,sub4,sub5);
}

void findTotalPercentage(int sub1, int sub2, int sub3, int sub4, int sub5){
