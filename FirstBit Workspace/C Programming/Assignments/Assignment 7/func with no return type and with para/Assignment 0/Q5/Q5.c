...
void findAverage(int*,int*,int*,int*,int*,float*);
void main(){
	...
	findAverage(&num1,&num2,&num3,&num4,&num5,&average);
...
void findAverage(int* num1, int* num2, int* num3, int* num4, int* num5, float* average){
