...
void main(){
	...
	calculateTotal(&basicSal,&totalSal);
...
void calculateTotal(int* basicSal, float* totalSal){

    float da, ta, hra, daPercentage, taPercentage, hraPercentage;
