...
public class TestVehicle {
	...
	public static void main(String[] args) {
		...
		Bike honda100 = new Bike("MH12 2003", "Honda100", "Honda", 2, 80000, 2, 1, "Semi Sports");
		Car maruti800 = new Car("MH12 6545", "Maruti800", "Maruti Suzuki", 4, 100000, false, "Manual", 0);
		Bus traveller01 = new Bus("MH12 2343", "Traveller01", "Travellers", 4, 200000, 10, 5);
		Bike unknown = new Bike();
