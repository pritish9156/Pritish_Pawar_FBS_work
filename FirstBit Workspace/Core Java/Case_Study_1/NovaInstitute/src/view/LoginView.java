...
public class LoginView {
    ...
    public LoginView(StudentController studController, CourseController courseController) {
    ...
    public void showLoginPage() {
        ...
        System.out.println("\t\t\t╠══════════════════════════════════════════════════════════════════════╣");
        System.out.println("\t\t\t║                                                                      ║");
        System.out.println("\t\t\t║                        🔐 LOGIN / SIGNUP PORTAL                      ║");
        System.out.println("\t\t\t║                                                                      ║");
        System.out.println("\t\t\t╠══════════════════════════════════════════════════════════════════════╣");
        System.out.println("\t\t\t║                                                                      ║");
    ...
    private void showLoading(String username, String password) {
        ...
        if(username.equals("admin") && password.equals("admin")) {
            ...
            DashboardView dashView = new DashboardView(studController, courseController);
